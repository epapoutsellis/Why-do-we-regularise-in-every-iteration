...
tv_denoising_dual_zarr = zarr.load("results/tv_denoising_dual_shapes_alpha_0.5.zarr")
...
operator = Div
F = (LeastSquares(A = operator, b=-noisy_data_cil, c=0.5) - 0.5*noisy_data_cil.squared_norm())
...
for run in range(num_runs):
    ...
    dd_fista = zarr.open_group("results/denoising_runs_alpha_{}/fista_run_{}_its_{}.zarr".format(alpha, run, num_iterations))
    ...
    dd_ista = zarr.open_group("results/denoising_runs_alpha_{}/ista_run_{}_its_{}.zarr".format(alpha, run, num_iterations))
    ...
    for prob in probs:
        ...
        dd_proxskip = zarr.open_group("results/denoising_runs_alpha_{}/proxskip_run_{}_prob_{}_its_{}.zarr".format(alpha, run, prob, num_iterations))
